...
import com.test.cache.dao.EmpMapper;
...
public class EmpService {
	 ...
	 *
	 *      sync
	 *      	是否使用异步模式，默认false，使用同步的方式
	 *      	如果true，则unless is not supported
	 *
	 * @param id
	 * @return
	 *
	 ...
	 * @CacheEvict 缓存清除
	 *  key：指定要清除的数据
	 *  allEntries：是否清除缓存中所有的数据，默认false
	 *  beforeInvocation：缓存的清除是否在方法之前执行，默认false，在方法之后执行，如果出现异常，缓存不会清除
	 *
	 */
	...
	public Emp getEmpByLastName(String lastName){
